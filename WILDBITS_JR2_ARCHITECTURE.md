...
| **WizFi360 Wi-Fi** | Dual 2KB FIFOs at `$FF20-$FF29`, AT command engine, socket bridge | **Completed & Verified** | Verified AT engine, transparent sockets, `INT_WIZFI_RX` (Group 3 bit 0), and `INT_WIZFI_TX` (Group 3 bit 5). |
